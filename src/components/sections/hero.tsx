          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='rounded-xl bg-gray-100 p-4 md:p-6 dark:bg-gray-100'>
              ...
              <div className='flex flex-row items-center gap-2 sm:gap-3 mb-4'>
                ...
                <div className='rounded-md bg-gray-200 px-3 py-1 dark:bg-gray-200 transition-all duration-300 hover:scale-110 hover:bg-gray-300 dark:hover:bg-gray-800 cursor-pointer whitespace-nowrap'>
            ...
            {/* Location Card */}
            <div className='rounded-xl bg-gray-100 p-4 md:p-6 dark:bg-gray-100'>
              <div className='flex items-center justify-between md:flex-row max-md:flex-col max-md:items-start max-md:gap-3'>
                ...
                <div className='text-left md:text-right flex flex-col md:flex-row md:items-center max-md:w-full'>
