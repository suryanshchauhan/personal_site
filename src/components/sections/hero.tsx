          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='rounded-xl bg-gray-100 p-4 md:p-6 dark:bg-gray-100'>
              ...
              <Typography className='text-gray-600 dark:text-gray-600 text-xs sm:text-sm leading-relaxed'>
                Developing web tools that keep trucks rolling, glitches rare, and the team smiling.
              </Typography>
            </div>
                ...
                <div className='flex items-center gap-2 sm:gap-3'>
                  ...
                  <div className='ml-1 sm:ml-2'>
                    ...
                    <div className='flex items-center gap-4'>
                     ...
                     <Typography className='text-gray-900 dark:text-gray-900 text-sm sm:text-base md:text-[10px] lg:text-base font-semibold'>
                        {currentTime}
                      </Typography>
                    </div>
                  </div>
